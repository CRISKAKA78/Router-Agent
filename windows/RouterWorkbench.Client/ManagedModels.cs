...
public sealed record ProbeTemplate(string TemplateId,string Name,ulong Version,MonitoringSettings? Monitoring,Dictionary<string,ProbeProperty> Properties,Presentation? Presentation=null, System.Text.Json.JsonElement? NeighborProbe=null)
{
