...
internal sealed class NeighborView : UserControl
{
 ...
 public NeighborView(string scope,Func<WorkspaceConnection?> connection,Func<Device?> device)
 {
  ...
  Content=new Border{Padding=new(16,10,16,16),Child=Ui.Page(new StackPanel{Children={controls,ranges,rangeInfo,advanced,rangeError,status,progress,operation,retention}},body)};
  Loaded+=(_,_)=>Update();
 }
 public void Update()
 {
