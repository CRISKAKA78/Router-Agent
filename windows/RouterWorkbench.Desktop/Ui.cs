...
internal static class Ui
{
    ...
    public static FrameworkElement NavigationHeader(string key, string title) {
        var header = (StackPanel)IconLabel(key switch { "overview" => "details", "maintenance" or "forwarding" or "networks" => "network", "serial" => "probe", "files" => "files", "config" => "config", "logs" => "files", _ => "tools" }, title);
