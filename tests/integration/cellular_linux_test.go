...
exec "$@"`
	...
	for _, capability := range []string{"neighbors_v1", "neighbors_inspect_v1", "cellular_identity_v1", "cellular_telemetry_v2", "cellular_details_v1", "device_logs_v1", "network_agent_v1"} {
