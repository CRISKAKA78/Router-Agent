...
func (a *Server) neighborRoutes() {
	a.route("GET /api/v1/capabilities", false, func(r *http.Request) response {
		return ok(object{"capabilities": []string{"neighbor_probe", "neighbors_inspect_v1", "neighbors_recent_v1", "cellular_identity_v1", "cellular_telemetry_v2", "cellular_details_v1"}}, nil)
	})
