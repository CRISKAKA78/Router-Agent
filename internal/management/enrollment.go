...
func (s *Server) UpdateDevice(id string, q DeviceUpdate) (enrollment.Profile, error) {
	...
	if e := probetemplate.Validate(probetemplate.Input{Name: t.Name, Properties: t.Properties, Monitoring: t.Monitoring, Presentation: t.Presentation, SwitchProbe: t.SwitchProbe, NeighborProbe: t.NeighborProbe}); e != nil {
