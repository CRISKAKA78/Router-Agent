...
func main() {
	...
	err := api.Run(ctx, *listenAddress, *httpAddress, management.Config{Forwarding: &fc, TemplateFile: *templateFile, RepositoryDirectory: *repositoryDirectory, Tunnel: &tunnelConfig, Gateway: gateway.Config{
